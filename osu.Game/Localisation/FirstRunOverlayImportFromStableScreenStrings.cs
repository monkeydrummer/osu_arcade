...
namespace osu.Game.Localisation
{
    public static class FirstRunOverlayImportFromStableScreenStrings
    {
        ...
        /// <summary>
        /// "If you have an installation of a previous USO version, you can choose to migrate your existing content. Note that this will not affect your existing installation's files in any way."
        /// </summary>
        public static LocalisableString Description => new TranslatableString(getKey(@"description"), $"If you have an installation of a previous {OsuBranding.Name} version, you can choose to migrate your existing content. Note that this will not affect your existing installation's files in any way.");

        /// <summary>
        /// "previous USO install"
        /// </summary>
        public static LocalisableString LocateDirectoryLabel => new TranslatableString(getKey(@"locate_directory_label"), "previous " + OsuBranding.Name + " install");

        /// <summary>
        /// "Click to locate a previous USO install"
        /// </summary>
        public static LocalisableString LocateDirectoryPlaceholder => new TranslatableString(getKey(@"locate_directory_placeholder"), "Click to locate a previous " + OsuBranding.Name + " install");
        ...
        /// <summary>
        /// "A second copy of all files will be made during import. To avoid this, please make sure the lazer data folder is on the same drive as your previous USO install (and the file system is NTFS)."
        /// </summary>
        public static LocalisableString SecondCopyWillBeMadeWindows => new TranslatableString(getKey(@"second_copy_will_be_made_windows"), $"A second copy of all files will be made during import. To avoid this, please make sure the lazer data folder is on the same drive as your previous {OsuBranding.Name} install (and the file system is NTFS).");

        /// <summary>
        /// "A second copy of all files will be made during import. To avoid this, please make sure the lazer data folder is on the same drive as your previous USO install (and the file system supports hard links)."
        /// </summary>
        public static LocalisableString SecondCopyWillBeMadeOtherPlatforms => new TranslatableString(getKey(@"second_copy_will_be_made_other_platforms"), $"A second copy of all files will be made during import. To avoid this, please make sure the lazer data folder is on the same drive as your previous {OsuBranding.Name} install (and the file system supports hard links).");
