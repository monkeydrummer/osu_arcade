...
namespace osu.Game.Localisation
{
    public static class FirstRunSetupOverlayStrings
    {
        ...
        /// <summary>
        /// "Set up USO to suit you"
        /// </summary>
        public static LocalisableString FirstRunSetupDescription => new TranslatableString(getKey(@"first_run_setup_description"), "Set up " + OsuBranding.Name + " to suit you");
        ...
        ///
        /// USO is a very configurable game, and diving straight into the settings can sometimes be overwhelming. This guide will help you get the important choices out of the way to ensure a great first experience!"
        /// </summary>
...
{OsuBranding.Name} is a very configurable game, and diving straight into the settings can sometimes be overwhelming. This guide will help you get the important choices out of the way to ensure a great first experience!");

        /// <summary>
        /// "The size of the USO user interface can be adjusted to your liking."
        /// </summary>
        public static LocalisableString UIScaleDescription => new TranslatableString(getKey(@"ui_scale_description"), $"The size of the {OsuBranding.Name} user interface can be adjusted to your liking.");
        ...
        ///
        /// We recommend you give the new defaults a try, but if you'd like to have things feel more like classic versions of USO, you can easily apply some sane defaults below."
        /// </summary>
        public static LocalisableString BehaviourDescription => new TranslatableString(getKey(@"behaviour_description"),
            $@"Some new defaults for game behaviours have been implemented, with the aim of improving the game experience and making it more accessible to everyone.

We recommend you give the new defaults a try, but if you'd like to have things feel more like classic versions of {OsuBranding.Name}, you can easily apply some sane defaults below.");
