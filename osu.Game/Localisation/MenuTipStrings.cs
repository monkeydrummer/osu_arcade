...
namespace osu.Game.Localisation
{
    public static class MenuTipStrings
    {
        ...
        /// <summary>
        /// "What used to be "USO direct" is available to all users just like on the website. You can access it anywhere using {0}!"
        /// </summary>
        public static LocalisableString FreeOsuDirect(LocalisableString keybind) => new TranslatableString(getKey(@"free_osu_direct"), $@"What used to be ""{OsuBranding.Name} direct"" is available to all users just like on the website. You can access it anywhere using {{0}}!", keybind);
